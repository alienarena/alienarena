...
$CONFIG['baseurl'] = "http://www.cooldark.com/aa/browser/"; /* Trailing slash important */
$CONFIG['stylesheet'] = "http://www.cooldark.com/aa/browser/style.css";
$CONFIG['dbHost'] = "localhost";
$CONFIG['dbName'] = "dbname_here";
$CONFIG['dbUser'] = "dbuser_here";
$CONFIG['dbPass'] = "dbpassword_here";
