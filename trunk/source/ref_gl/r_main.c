...
void R_Register( void )
{
	...
	gl_skyboxscale = Cvar_Get ("gl_skyboxscale", "1", CVAR_ARCHIVE|CVARDOC_FLOAT);
	Cvar_Describe (gl_skyboxscale, "Move the skybox closer by setting this less than 1. Only use this if your hardware doesn't support a 24-bit depth buffer and the skybox is disappearing. Don't set this above 1.");
