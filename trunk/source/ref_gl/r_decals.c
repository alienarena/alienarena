...
void __attribute__((optimize("O0"))) Mod_AddToDecalModel (const vec3_t mins, const vec3_t maxs, const vec3_t origin, const vec3_t angles, model_t *terrainmodel, decalprogress_t *out)
{
