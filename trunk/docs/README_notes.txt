...
=== INSTALL ===
TODO: this usually has the documentation for install-sh. may want to.
...
$ sudo make install            <- installs files as above
...
=== CHANGELOG ===
TODO: the release change log should go here.

=== AUTHORS ===
TODO: reference README.txt
