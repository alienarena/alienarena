...
/*--------------------------------------------------------- Memory Management */
void *Com_xmalloc( size_t size );
void *Com_xmalloc0( size_t size );
void *Com_xcalloc( size_t count, size_t elemsize );
void *Com_xrealloc( void *p, size_t newsize );
void  Com_xfree( void *p );
