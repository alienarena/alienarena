...
# ADD LINK32 libcmt.lib oldnames.lib kernel32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib /out:"c:/Alien Arena 2007/data1/maps/qvis3.exe"
...
# ADD LINK32 /nologo /subsystem:console /debug /machine:I386 /out:"..\Debug/qvis3.exe"
